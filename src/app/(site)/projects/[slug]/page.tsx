...
export async function generateMetadata({ params }: Props) {
    ...
    const project = getProjectsBySlug(slug, ["EnvironmentFriendly","School", "ScopeOfWork","raised", "website", "description", "coverImage", "gallery", "content"]);
...
export default async function Post({ params }: Props) {
    ...
    const project = getProjectsBySlug(slug, [
       "EnvironmentFriendly","school", "ScopeOfWork","raised", "website", "description", "coverImage", "gallery", "content"
    ]);
                        ...
                        <div className="flex flex-col gap-12 md:gap-24 py-20 xl:py-40">
                            <div className="flex flex-col gap-10">
                                ...
                                <div className="flex flex-col md:flex-row gap-5 lg:gap-10">
                                    ...
                                    <div className="flex flex-col gap-2 border-b md:border-b-0 md:border-r border-secondary/12 dark:border-white/12 pb-5 md:pr-5 lg:pr-10">
                                        <span className="text-base text-secondary/70 dark:text-white/70">School</span>
                                        <p className="font-medium">{project.school}</p>
                                    </div>
                                    <div className="flex flex-col gap-2 border-b md:border-b-0 md:border-r border-secondary/12 dark:border-white/12 pb-5 md:pr-5 lg:pr-10">
