                        ...
                        <div className="flex flex-col gap-6 Xxl:pb-20 pb-10">
                            <div className="flex items-start gap-2 md:gap-6">
                                ...
                                <p className="text-white/70 max-w-md">
                                   Empowering young minds to take <span className="text-primary">eco-friendly actions</span> every day for a cleaner environment.
                                </p>
                            </div>
                            <div className="flex flex-col lg:flex-row items-start lg:items-end gap-4">
                                <h1 className="large-heading">Winwee</h1>
                                <div>
